...
extern "C" void app_main(void) {
  ...
  //             NULL);
  // xTaskCreate(tx_task, "uart_tx_task", 1024 * 2, NULL, configMAX_PRIORITIES - 1,
  //             NULL);
  xTaskCreatePinnedToCore(blinkTask, "blink", min * 2, NULL, 1, &blink, c0);
  xTaskCreatePinnedToCore(encoderTask, "encoder", min * 4, NULL, 1, &encoder, c0);
}
